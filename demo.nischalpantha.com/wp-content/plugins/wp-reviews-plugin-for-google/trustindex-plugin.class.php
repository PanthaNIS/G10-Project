...
$chosed_platform = new TrustindexPlugin($force_platform, $file_path, "do-not-care-7.9.1", "do-not-care-Widgets for Google Reviews", "do-not-care-Google");
