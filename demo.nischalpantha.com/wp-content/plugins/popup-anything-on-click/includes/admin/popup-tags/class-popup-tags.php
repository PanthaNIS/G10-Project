...
class Popupaoc_Popup_Tags {
	...
	function popupaoc_general_tags_html() { ?>
		...
		<div class="paoc-modal-sub-title"><strong># <?php _e('General Tags', 'popup-anything-on-click'); ?></strong></div>
		...
		<table class="wp-list-table widefat fixed striped paoc-tags-tbl">
			<tbody>
				<tr>
					...
					<td><?php _e('Display website name.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display website URL.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display website logo.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display admin email addresss.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display user name.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display user email addresss.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display current page or post title.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display current post excerpt.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display current date & time.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display current date.', 'popup-anything-on-click'); ?></td>
				</tr>
				<tr>
					...
					<td><?php _e('Display current year.', 'popup-anything-on-click'); ?></td>
				</tr>
			</tbody>
		</table>
	<?php }
