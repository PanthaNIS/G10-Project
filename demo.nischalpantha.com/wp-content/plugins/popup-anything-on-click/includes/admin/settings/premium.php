		...
		<div id="post-body" class="metabox-holder columns-2">
					...
					<thead>
						<tr>
							...
							<th>
								...
								<a href="<?php echo POPUPAOC_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Popup-Anything&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
							</th>	    		
						</tr>
					</thead>
			...
			<div id="postbox-container-1" class="postbox-container wpos-sidebar">
				<div class="wpos-epb-wrap">
					...
					<ul>
						<li><b>40+ Utility Plugins</b> including <span>Popup Anything on Click </span> premium version.</li>
					...
					<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo POPUPAOC_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Popup-Anything&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
				</div>
