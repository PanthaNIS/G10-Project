	...
	<div class="inside">
		<table class="form-table paoc-tbl">
			<tbody>
				<tr>
					<th>
						<label for="paoc-enable"><?php _e('Enable', 'popup-anything-on-click'); ?></label>
					</th>
					<td>
						...
						<span class="description"><?php _e('Check this box if you want to enable popup.', 'popup-anything-on-click'); ?></span>
					</td>
				</tr>

				<tr>
					<th>
						<label for="paoc-cookie-prefix"><?php _e('Cookie Prefix', 'popup-anything-on-click'); ?></label>
					</th>
					<td>
						<input type="text" name="popupaoc_options[cookie_prefix]" value="<?php echo popupaoc_esc_attr( $cookie_prefix ); ?>" id="paoc-cookie-prefix" class="paoc-text paoc-cookie-prefix"><br/>
						<span class="description"><?php _e('Enter cookie prefix. Changing the value will display the cookie based popup again. Default cookie prefix is "paoc_popup".', 'popup-anything-on-click'); ?></span>
					</td>
				</tr>

				<tr>
					<th>
						<label for="paoc-pro-add-js"><?php _e('Manage Polyfill JS', 'popup-anything-on-click'); ?></label>
					</th>
					<td>
